...
func_body         : decl /*{SemanticDataHandler.displayCurrentScope();}*/ stmt_list ;
...
if_stmt           : 'IF' {SemanticDataHandler.pushNewScope(SCOPE.BLOCK, null);}'(' cond ')' decl /*{SemanticDataHandler.displayCurrentScope();}*/ {SemanticDataHandler.popCurrentScope();} stmt_list else_part 'FI';
else_part         : 'ELSE' {SemanticDataHandler.pushNewScope(SCOPE.BLOCK, null);} decl /*{SemanticDataHandler.displayCurrentScope();}*/ stmt_list {SemanticDataHandler.popCurrentScope();}| ;
