...
public interface MicroListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterInit_stmt(@NotNull MicroParser.Init_stmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#init_stmt}.
	 * @param ctx the parse tree
	 */
	void exitInit_stmt(@NotNull MicroParser.Init_stmtContext ctx);
	 ...
	 * @param ctx the parse tree
	 */
	void enterIncr_stmt(@NotNull MicroParser.Incr_stmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#incr_stmt}.
	 * @param ctx the parse tree
	 */
	void exitIncr_stmt(@NotNull MicroParser.Incr_stmtContext ctx);
